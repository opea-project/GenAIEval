...
from .schemas import AnnotationRequest, AnnotationResponse, GTMatchResult, QueryGTMatchResults, SuggestionItem
...
class Annotator:
    ...
    def annotate(self, request: AnnotationRequest) -> AnnotationResponse:
        try:
            ...
            return AnnotationResponse(success=False, message=f"Annotation failed: {str(e)}", suggestion_items=[])
