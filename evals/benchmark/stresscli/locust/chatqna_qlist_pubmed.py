...
PROMPT = os.getenv('PROMPT', f". Give me the content related to this title and please repeat the answer multiple times till the word count exceeds {MAX_WORDS}.")
...
def getRandomDocument():
    ...
    logging.error(f"Failed to find valid document after ")
    return None
