...
# Benchmark for Rerank service for OpenVINO model_server, Cohere API and Jina API
# https://github.com/openvinotoolkit/model_server/blob/main/demos/rerank/README.md
...
def getReqData():
    return {"model": model_id, "query": my_query, "documents": [query_rerank_1, query_rerank_2]}
