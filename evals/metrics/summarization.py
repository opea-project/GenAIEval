...
class SummarizationMetric:
    ...
    def rouge_scores(self, text1, text2):
        eval_rouge = self.rouge.get_scores(text1, text2)
    ...
    def summarize(self, document: str, ref_summary: str, **generation_kwargs):
        req = {
                "inputs": SummarizationTemplate.generate_summary(document),
    ...
    def average_score(self):
        return {metric: sum(self.metrics[metric])/len(self.metrics[metric]) \
